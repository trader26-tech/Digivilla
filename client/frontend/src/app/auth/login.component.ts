...
export class LoginComponent {
  /** Emitted once the phone is verified. The success tick + "book your setup
   *  call" onboarding now lives past the gate, so verifying is all login does. */
  ...
  async verify(): Promise<void> {
    ...
    this.error.set('');
    try {
      // No more profile-details step — the setup call (advisor-led) collects
      // everything. Verifying the phone is the whole of login now.
